...
/**
 * Converts variations report JSON data to CSV in the format of the 
 * @param {Object} jsonData variations report data containing a variations array
 */
const convertVariationsJsonToCsv = variationsReportJson => {
  return JSON.stringify(variationsReportJson);
};

module.exports = {
  convertVariationsCsvToJson,
  convertVariationsJsonToCsv
};
