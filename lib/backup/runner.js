 ...
 * @param {String} [args.region] AWS region for the S3 client
 ...
 * @param {String} [args.keyPrefix] S3 key prefix; defaults to `<YYYY-MM-DD>/<startMs>`
...
const runBackup = async ({
  ...
  const prefix = keyPrefix || `${new Date(started).toISOString().slice(0, 10)}/${started}`;
