...
const validate = ({
  ...
  const payload = structuredClone(jsonPayload);
  let schemaId;
...
const generateErrorReport = ({
  ...
  validate.errors.reduce((acc, { instancePath, message, keyword, params, failedItemValue: value, isWarning, schemaPath, transformedValue }) => {
