...
const getValidDdVersions = () => Object.values(DATA_DICTIONARY_VERSIONS ?? {});
...
const validate = ({ jsonSchema = {}, resourceName = 'Property', jsonPayload, errorMap = {}, fileName = '', version } = {}) => {
  ...
  try {
    ...
    if (!isValidDdVersion(ddVersion)) {
      throw new Error(`Found invalid DD version ${ddVersion} - Supported versions are ${getValidDdVersions()}`);
    }
