...
const generateErrorReport = ({
  ...
  validate.errors.reduce((acc, { instancePath, message, keyword, params }) => {
    ...
    updateErrorCache({ errorCache, resourceName: rname, failedItemName, message, fileName, stats });
    return acc;
  }, {});
};
 ...
 */
const updateErrorCache = ({ errorCache, resourceName, failedItemName, message, fileName, stats }) => {
