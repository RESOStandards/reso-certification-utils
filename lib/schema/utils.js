 ...
 * @param {*} message
 * @param {*} payloadErrors
 * @param {{totalErrors: number, totalWarnings: number}} stats
 */
const addPayloadError = (resource, fileName, message, payloadErrors, stats) => {
...
const combineErrors = ({
  ...
  return {
    ...
    payloadErrors: changeKeyMapToList(payloadErrors),
  };
};
