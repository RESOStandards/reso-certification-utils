...
// this will support up to 80M unique hashes, if sufficient memory exists
const NUM_RECORD_COUNT_HASHMAPS = 10;
...
/**
 * Only used during testing to reset the record count hash maps after each test
 */
const resetRecordCountHashMaps = () => {
  for (let i = 0; i < NUM_RECORD_COUNT_HASHMAPS; i++) {
    _recordCountHashMaps[i] = {};
  }
};
